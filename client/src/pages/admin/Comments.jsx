...
const Comments = () => {
  ...
  const [filter, setFilter] = useState('Npt Approved');
  ...
  return (
    <div className='flex-1 pt-5 px-5 sm:pt-12 sm:pl-16 bg-blue-50/50'>
      ...
      <div className='relative h-4/5 mt-4 max-w-3xl overflow-x-auto shadow rounded-lg
        scrollbar-hide bg-white'>
          <table className='w-full text-sm text-gray-500'>
            ...
            <tbody>
              ...
              key={comment._id} comment={comment} index={index + 1}
